...
function Reno8T() {
  return (
    <div>
        <Header />
        <div>
            <h3 className='reno-text'>Điện thoại di động Reno8 T 5G - Chính hãng</h3>
            <div className='reno'>
                <div className='reno-1'>
                <Carousel autoplay>
                    <Image src='https://cdn.hoanghamobile.com/i/productlist/dsp/Uploads/2023/01/12/image-removebg-preview-16.png' alt='anh-1' /> 
                ...
                <div>
                    <div className='reno-line'>
                        <h3>9,990,000 ₫</h3><del>9,990,000 ₫</del>
            ...
            <div className='reno8T-danhgia'>
                <div className='danhgia-line'>
                    <h3 className='danhgia-text-1'>Đánh giá về Redmi Note 12 (4GB/128GB) - Chính hãng</h3>
